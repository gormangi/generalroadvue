<template>
  <div class="page-inner">
    ...
    <div class="page-header" :class="{'content-disabled': isLoading}">
      <h3 class="fw-bold mb-3">배너 추가</h3>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-action">
            <button type="button" @click="methods.bannerAdd" class="btn btn-success" style="margin-right:10px;">추가</button>
...
const methods = {
  ...
  async bannerAdd() {
    ...
    if (Object.keys(bannerImgVO.value).length === 0 && bannerImgVO.value.constructor === Object) {
      alert('배너이미지를 반드시 등록해야 합니다');
      return false;
    }
    ...
    startLoading();
    await $fetch('/api/banner/addBanner', {method: 'post', body: bannerReq}).finally(() => stopLoading());
    router.back();
  },
